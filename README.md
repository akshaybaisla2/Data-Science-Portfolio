...
- **Machine learning Projects with deployment**<br>- [Salary prediction](https://github.com/akshaybaisla2/Salary_Prediction) A simple Salary Prediction model based on Experience, Test score and Interview score deployed on Heroku cloud platform.<br>- *Final output: <https://salary-prediction-dep.herokuapp.com/>* : Enter the required fields to get salary prediction<br>
...
*Tools:Pandas,Numpy,Seaborn,Matplotlib,Requests,sklearn*
