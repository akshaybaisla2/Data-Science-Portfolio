...
- **Data Analysis and Visualisation**
  ...
  - [Thyroid Detection](): EDA on thyroid detection dataset insights from this eda are later used to build a classification methodology to predict the type of Thyroid based on training data.
